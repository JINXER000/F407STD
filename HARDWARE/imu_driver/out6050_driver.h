...
void outMPU6050_InitGyro_Offset_Start(void);
void outMPU6050_InitGyro_Offset_Save(void);
void outInit_Encoder_Offset_Start(void);
void outInit_Encoder_Offset_Save(void);
...
void outMPU6050_DataSave(int16_t ax,int16_t ay,int16_t az,int16_t gx,int16_t gy,int16_t gz);
void  outHMC58X3_newValues(int16_t x,int16_t y,int16_t z);
void outHMC5883L_Start_Calib(void);
void outHMC5883L_Save_Calib(void);
void outMPU6050_getMotion6(int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz);
void outMPU6050_getlastMotion6(int16_t* ax, int16_t* ay, int16_t* az, int16_t* gx, int16_t* gy, int16_t* gz);
void outReset_MAG_MinMaxVal(void);
